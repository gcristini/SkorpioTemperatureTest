...
static void ADC_SetDFTControl(const ADC_CONFIG_STRUCT *config);
...
static uint32 ADC_GetCompStatus(void);
...
static const uint32 CYCODE ADC_channelsConfig[] = { 0x00000000UL,  };

/* Filter init */
#if(ADC_ANY_CONFIG_USES_FILTER != 0u)
    #if (0u != ADC_CFG0_FILTER_PRESENT)
        #define ADC_CFG0_UABH_A_FILTER_INITPAIRSSIZE (19u)
        const static CyUAB_reg_pair ADC_CFG0_UABH_A_FILTER_initPairs[ADC_CFG0_UABH_A_FILTER_INITPAIRSSIZE] =
        {
            ...
            ,{ADC_UABH_A_SW_CA_IN1_PTR      , ((uint32)ADC_UABH_A_DEFAULT_SW_CA_IN1)}
        ...
        #define ADC_CFG0_UABH_B_FILTER_INITPAIRSSIZE (19u)
        const static CyUAB_reg_pair ADC_CFG0_UABH_B_FILTER_initPairs[ADC_CFG0_UABH_B_FILTER_INITPAIRSSIZE] =
        {
            /*OA_CTRL default always first element in initPairs*/
            /* Topology-invariant registers */
        ...
        const static CyUAB_config ADC_CFG0_UABH_A_FILTER_config = {
            ADC_UABH_A_waveConfig,
            (CyUAB_reg_pair*) ADC_CFG0_UABH_A_FILTER_initPairs,
        ...
        const static CyUAB_config ADC_CFG0_UABH_B_FILTER_config = {
        ADC_UABH_B_waveConfig,
        (CyUAB_reg_pair*) ADC_CFG0_UABH_B_FILTER_initPairs,
        ...
        #define ADC_CFG1_UABH_A_FILTER_INITPAIRSSIZE (19u)
        const static CyUAB_reg_pair ADC_CFG1_UABH_A_FILTER_initPairs[ADC_CFG1_UABH_A_FILTER_INITPAIRSSIZE] =
        {
            /*OA_CTRL default always first element in initPairs*/
            /* Topology-invariant registers */
             {ADC_UABH_A_OA_CTRL_PTR        , ((uint32)ADC_UABH_A_DEFAULT_OA_CTRL)}
        ...
        #define ADC_CFG1_UABH_B_FILTER_INITPAIRSSIZE (19u)
        const static CyUAB_reg_pair ADC_CFG1_UABH_B_FILTER_initPairs[ADC_CFG1_UABH_B_FILTER_INITPAIRSSIZE] =
        {
            /*OA_CTRL default always first element in initPairs*/
            /* Topology-invariant registers */
             {ADC_UABH_B_OA_CTRL_PTR        , ((uint32)ADC_UABH_B_DEFAULT_OA_CTRL)}
        ...
        const static CyUAB_config ADC_CFG1_UABH_A_FILTER_config = {
            ADC_UABH_A_waveConfig,
            (CyUAB_reg_pair*) ADC_CFG1_UABH_A_FILTER_initPairs,
            CyUAB_SHARED_SW_CFG(ADC_UABH_A_PARAM_REF_TIED,ADC_UABH_A_PARAM_AGND_TIED,
                ADC_UABH_A_PARAM_SW_CC,ADC_UABH_A_PARAM_SW_BB,ADC_UABH_A_PARAM_SW_AA),
            ADC_UABH_A_NUM_STEPS,
        ...
        const static CyUAB_config ADC_CFG1_UABH_B_FILTER_config = {
        ADC_UABH_B_waveConfig,
        (CyUAB_reg_pair*) ADC_CFG1_UABH_B_FILTER_initPairs,
        CyUAB_SHARED_SW_CFG(ADC_UABH_B_PARAM_REF_TIED,ADC_UABH_B_PARAM_AGND_TIED,
            ADC_UABH_B_PARAM_SW_CC,ADC_UABH_B_PARAM_SW_BB,ADC_UABH_B_PARAM_SW_AA),
        ADC_UABH_B_NUM_STEPS,
        ...
        #define ADC_CFG2_UABH_A_FILTER_INITPAIRSSIZE (19u)
        const static CyUAB_reg_pair ADC_CFG2_UABH_A_FILTER_initPairs[ADC_CFG2_UABH_A_FILTER_INITPAIRSSIZE] =
        {
            /*OA_CTRL default always first element in initPairs*/
            /* Topology-invariant registers */
             {ADC_UABH_A_OA_CTRL_PTR        , ((uint32)ADC_UABH_A_DEFAULT_OA_CTRL)}
        ...
        #define ADC_CFG2_UABH_B_FILTER_INITPAIRSSIZE (19u)
        const static CyUAB_reg_pair ADC_CFG2_UABH_B_FILTER_initPairs[ADC_CFG2_UABH_B_FILTER_INITPAIRSSIZE] =
        {
            /*OA_CTRL default always first element in initPairs*/
            /* Topology-invariant registers */
             {ADC_UABH_B_OA_CTRL_PTR        , ((uint32)ADC_UABH_B_DEFAULT_OA_CTRL)}
        ...
        const static CyUAB_config ADC_CFG2_UABH_A_FILTER_config = {
            ADC_UABH_A_waveConfig,
            (CyUAB_reg_pair*) ADC_CFG2_UABH_A_FILTER_initPairs,
            CyUAB_SHARED_SW_CFG(ADC_UABH_A_PARAM_REF_TIED,ADC_UABH_A_PARAM_AGND_TIED,
                ADC_UABH_A_PARAM_SW_CC,ADC_UABH_A_PARAM_SW_BB,ADC_UABH_A_PARAM_SW_AA),
            ADC_UABH_A_NUM_STEPS,
        ...
        const static CyUAB_config ADC_CFG2_UABH_B_FILTER_config = {
        ADC_UABH_B_waveConfig,
        (CyUAB_reg_pair*) ADC_CFG2_UABH_B_FILTER_initPairs,
        CyUAB_SHARED_SW_CFG(ADC_UABH_B_PARAM_REF_TIED,ADC_UABH_B_PARAM_AGND_TIED,
            ADC_UABH_B_PARAM_SW_CC,ADC_UABH_B_PARAM_SW_BB,ADC_UABH_B_PARAM_SW_AA),
        ADC_UABH_B_NUM_STEPS,
        ...
        #define ADC_CFG3_UABH_A_FILTER_INITPAIRSSIZE (19u)
        const static CyUAB_reg_pair ADC_CFG3_UABH_A_FILTER_initPairs[ADC_CFG3_UABH_A_FILTER_INITPAIRSSIZE] =
        {
            /*OA_CTRL default always first element in initPairs*/
            /* Topology-invariant registers */
             {ADC_UABH_A_OA_CTRL_PTR        , ((uint32)ADC_UABH_A_DEFAULT_OA_CTRL)}
        ...
        #define ADC_CFG3_UABH_B_FILTER_INITPAIRSSIZE (19u)
        const static CyUAB_reg_pair ADC_CFG3_UABH_B_FILTER_initPairs[ADC_CFG3_UABH_B_FILTER_INITPAIRSSIZE] =
        {
            /*OA_CTRL default always first element in initPairs*/
            /* Topology-invariant registers */
             {ADC_UABH_B_OA_CTRL_PTR        , ((uint32)ADC_UABH_B_DEFAULT_OA_CTRL)}
        ...
        const static CyUAB_config ADC_CFG3_UABH_A_FILTER_config = {
            ADC_UABH_A_waveConfig,
            (CyUAB_reg_pair*) ADC_CFG3_UABH_A_FILTER_initPairs,
            CyUAB_SHARED_SW_CFG(ADC_UABH_A_PARAM_REF_TIED,ADC_UABH_A_PARAM_AGND_TIED,
                ADC_UABH_A_PARAM_SW_CC,ADC_UABH_A_PARAM_SW_BB,ADC_UABH_A_PARAM_SW_AA),
            ADC_UABH_A_NUM_STEPS,
        ...
        const static CyUAB_config ADC_CFG3_UABH_B_FILTER_config = {
        ADC_UABH_B_waveConfig,
        (CyUAB_reg_pair*) ADC_CFG3_UABH_B_FILTER_initPairs,
        CyUAB_SHARED_SW_CFG(ADC_UABH_B_PARAM_REF_TIED,ADC_UABH_B_PARAM_AGND_TIED,
            ADC_UABH_B_PARAM_SW_CC,ADC_UABH_B_PARAM_SW_BB,ADC_UABH_B_PARAM_SW_AA),
        ADC_UABH_B_NUM_STEPS,
...
/* ****************************************************************************
* Function Name: ADC_SetDFTControl
****************************************************************************//*
*
...
static void ADC_SetDFTControl(const ADC_CONFIG_STRUCT *config)
{
    ...
    uint32 tmpRegVal = ADC_SAR_DFT_CTRL_REG;
...
*
* \param restart Set to 1u to restart the ADC after
...
int32 ADC_CountsTo_uVolts(uint32 chan, int16 adcCounts)
{
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: ADC_SetupComparatorTrim
    ********************************************************************************
    *
    ...
    *******************************************************************************/
    static void ADC_SetupComparatorTrim(void)
    {
        ADC_filterVinMux_Select(ADC_FILTER_AMUX_CHANNEL);
    }

    /*******************************************************************************
    * Function Name: ADC_UndoComparatorTrimSetup
    ********************************************************************************
    *
    * Undo all changes made in ADC_SetupComparatorTrim()
    * to bring the Component back to normal operation.
    *
    *******************************************************************************/
    static void ADC_UndoComparatorTrimSetup(void)
    {
        ADC_filterVinMux_Select((uint8)ADC_currentConfig);
    }

    /*******************************************************************************
    * Function Name: ADC_RaiseOpampTrimToCrossing
    ********************************************************************************
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: ADC_LowerOpampTrimToCrossing
    ********************************************************************************
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: ADC_RaiseAgndTrimToCrossing
    ********************************************************************************
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: ADC_LowerAgndTrimToCrossing
    ********************************************************************************
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: ADC_SetOpampAndAgndTrim
    ********************************************************************************
    *
    ...
    *******************************************************************************/
    static uint32 ADC_SetOpampAndAgndTrim(uint32 opampTrim, uint32 agndTrim)
    {
        uint32 trimRegVal = ADC_UABH_A_OA_TRIM_OA_REG;
        trimRegVal &= ~(ADC_OPAMP_TRIM_MASK << CyUAB_OA_OFFSET_SHIFT);
        trimRegVal |= (opampTrim << CyUAB_OA_OFFSET_SHIFT);
        ADC_UABH_A_OA_TRIM_OA_REG = trimRegVal;

        trimRegVal = ADC_UABH_A_OA_TRIM_AGND_REG;
        trimRegVal &= ~(ADC_AGND_TRIM_MASK << CyUAB_AGND_OFFSET_SHIFT);
        trimRegVal |= (agndTrim << CyUAB_AGND_OFFSET_SHIFT);
        ADC_UABH_A_OA_TRIM_AGND_REG = trimRegVal;

        return ADC_GetCompStatus();
    }

    /*******************************************************************************
    * Function Name: ADC_SetOpampTrim
    ********************************************************************************
    *
    ...
    *******************************************************************************/
    static uint32 ADC_SetAgndTrim(uint32 agndTrim)
    {
        uint32 trimRegVal = ADC_UABH_A_OA_TRIM_AGND_REG;
        trimRegVal &= ~(ADC_AGND_TRIM_MASK << CyUAB_AGND_OFFSET_SHIFT);
        trimRegVal |= (agndTrim << CyUAB_AGND_OFFSET_SHIFT);
        ADC_UABH_A_OA_TRIM_AGND_REG = trimRegVal;
    ...
    /*******************************************************************************
    * Function Name: ADC_GetCompStatus
    ********************************************************************************
    *
    ...
    *******************************************************************************/
    static uint32 ADC_GetCompStatus(void)
    {
        ...
        CyDelayUs(ADC_allConfigs[ADC_currentConfig].filterTrimDelay);
        ...
        if (ADC_GetResult16(ADC_FILTER_ADC_CHANNEL) < zeroCode)
        {
            compStatus = 1UL;
        }
    ...
    /*******************************************************************************
    * Function Name: ADC_IncOpampTrim
    ********************************************************************************
    *
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: ADC_DecOpampTrim
    ********************************************************************************
    *
...
void ADC_Enable(void)
{
    ...
    ADC_SetDFTControl(&ADC_allConfigs[ADC_currentConfig]);
