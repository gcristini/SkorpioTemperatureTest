...
* Filter Parameters
*******************************************************************************/
#define ADC_FILTER_ADC_CHANNEL     (0UL)
#define ADC_FILTER_AMUX_CHANNEL    (4U)
...
#define ADC_UABH_ALL_OPEN_CC_IN0   (uint32)((CyUAB_CLK_PHI4 << CyUAB_SW_C0_MODBIT_SHIFT) \
...
#define ADC_UABH_ALL_OPEN_CB_IN0   (uint32)((CyUAB_CLK_PHI4 << CyUAB_SW_B0_MODBIT_SHIFT) \
...
#define ADC_UABH_A_LOWQSTAT_SW_CA_IN0 ((CyUAB_CLK_PHI5 << CyUAB_SW_AP_SHIFT) \
...
#define ADC_UABH_A_LOWQSTAT_SW_CA_TOP ((CyUAB_CLK_PHI5 << CyUAB_SW_SA_SHIFT) \
...
#define ADC_UABH_A_LOWQSTAT_SW_CF_BOT ((CyUAB_CLK_PHI5 << CyUAB_SW_PF_SHIFT) \
...
#define ADC_UABH_B_LOWQSTAT_SW_CC_IN0 ((ADC_UABH_ALL_OPEN_CC_IN0 \
                                                &   ~((uint32)CyUAB_CLOCK_MASK << (ADC_UABH_B_halfuab__X0 << 2u))) \
                                                |   ((uint32)CyUAB_CLK_PHI5 << (ADC_UABH_B_halfuab__X0 << 2u)))

#define ADC_UABH_B_LOWQSTAT_SW_CC_IN1 ((CyUAB_CLK_PHI4 << CyUAB_SW_CG_MODBIT_SHIFT) \
                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_CR_MODBIT_SHIFT) \
                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_CV_MODBIT_SHIFT) \
                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_CC_SHIFT))

#define ADC_UABH_B_LOWQSTAT_SW_CF_BOT ((CyUAB_CLK_PHI5 << CyUAB_SW_PF_SHIFT) \
                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_GF_SHIFT) \
                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_PS_SHIFT) \
...
#define ADC_UABH_A_HIGHQSTAT_SW_CA_IN0 ((CyUAB_CLK_PHI5 << CyUAB_SW_AQ_SHIFT) \
                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_A0_MODBIT_SHIFT) \
                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_A1_MODBIT_SHIFT) \
                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_A2_MODBIT_SHIFT) \
                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_A3_MODBIT_SHIFT) \
...
#define ADC_UABH_A_HIGHQSTAT_SW_CA_TOP ((CyUAB_CLK_PHI5 << CyUAB_SW_SA_SHIFT) \
                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_RA_MODBIT_SHIFT) \
                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_GA_MODBIT_SHIFT) \
                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_VA_MODBIT_SHIFT))
...
#define ADC_UABH_A_HIGHQSTAT_SW_CC_IN0 ((ADC_UABH_ALL_OPEN_CC_IN0 \
                                                &   ~((uint32)CyUAB_CLOCK_MASK << (ADC_UABH_A_halfuab__X0 << 2u))) \
                                                |   (uint32)CyUAB_CLK_PHI5 << (ADC_UABH_A_halfuab__X0 << 2u))

#define ADC_UABH_A_HIGHQSTAT_SW_CC_IN1 ((CyUAB_CLK_PHI4 << CyUAB_SW_CG_MODBIT_SHIFT) \
                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_CR_MODBIT_SHIFT) \
                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_CV_MODBIT_SHIFT) \
                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_CC_SHIFT))

#define ADC_UABH_A_HIGHQSTAT_SW_CC_TOP ((CyUAB_CLK_PHI5 << CyUAB_SW_TC_SHIFT) \
...
#define ADC_UABH_A_HIGHQSTAT_SW_CF_BOT ((CyUAB_CLK_PHI5 << CyUAB_SW_PF_SHIFT) \
                                                |    (CyUAB_CLK_PHI4 << CyUAB_SW_GF_SHIFT) \
                                                |    (CyUAB_CLK_PHI4 << CyUAB_SW_PS_SHIFT) \
                                                |    (CyUAB_CLK_PHI4 << CyUAB_SW_PO_SHIFT))
...
#define ADC_UABH_B_HIGHQSTAT_SW_CB_IN0 ((ADC_UABH_ALL_OPEN_CB_IN0 \
                                                &   ~((uint32)CyUAB_CLOCK_MASK << (ADC_UABH_B_halfuab__X0 << 2u))) \
                                                |   CyUAB_CLK_PHI5 << (ADC_UABH_B_halfuab__X0 << 2u))

#define ADC_UABH_B_HIGHQSTAT_SW_CB_IN1 ((CyUAB_CLK_PHI4 << CyUAB_SW_BG_MODBIT_SHIFT) \
                                                |    (CyUAB_CLK_PHI4 << CyUAB_SW_BR_MODBIT_SHIFT) \
                                                |    (CyUAB_CLK_PHI4 << CyUAB_SW_BV_MODBIT_SHIFT) \
                                                |    (CyUAB_CLK_PHI4 << CyUAB_SW_BB_SHIFT))

#define ADC_UABH_B_HIGHQSTAT_SW_CC_IN0 ((ADC_UABH_ALL_OPEN_CC_IN0 \
                                                &   ~((uint32)CyUAB_CLOCK_MASK << (ADC_UABH_B_halfuab__X0 << 2u))) \
                                                |   (uint32)CyUAB_CLK_PHI1 << (ADC_UABH_B_halfuab__X0 << 2u))

#define ADC_UABH_B_HIGHQSTAT_SW_CC_IN1 ((CyUAB_CLK_PHI2 << CyUAB_SW_CG_MODBIT_SHIFT) \
                                                |    (CyUAB_CLK_PHI4 << CyUAB_SW_CR_MODBIT_SHIFT) \
                                                |    (CyUAB_CLK_PHI4 << CyUAB_SW_CV_MODBIT_SHIFT) \
                                                |    (CyUAB_CLK_PHI4 << CyUAB_SW_CC_SHIFT))

#define ADC_UABH_B_HIGHQSTAT_SW_CF_BOT ((CyUAB_CLK_PHI5 << CyUAB_SW_PF_SHIFT) \
                                                |    (CyUAB_CLK_PHI4 << CyUAB_SW_GF_SHIFT) \
                                                |    (CyUAB_CLK_PHI4 << CyUAB_SW_PS_SHIFT) \
                                                |    (CyUAB_CLK_PHI3 << CyUAB_SW_PO_SHIFT))
...
*******************************************************************************/
    ...
    #define ADC_CFG0_TRANSFERTYPE      ADC_TRANSFERTYPE_LOW_PASS
    ...
    #define ADC_CFG0_FILTER_IDEAL_BIQUAD_NUM0      (0)
    #define ADC_CFG0_FILTER_IDEAL_BIQUAD_NUM1      (0)
    #define ADC_CFG0_FILTER_IDEAL_BIQUAD_NUM2      (0)
    #define ADC_CFG0_FILTER_IDEAL_BIQUAD_DEN0      (0)
    #define ADC_CFG0_FILTER_IDEAL_BIQUAD_DEN1      (0)
    #define ADC_CFG0_FILTER_IDEAL_BIQUAD_DEN2      (0)

    #define ADC_CFG0_FILTER_UAB_BIQUAD_NUM0        (0)
    #define ADC_CFG0_FILTER_UAB_BIQUAD_NUM1        (0)
    #define ADC_CFG0_FILTER_UAB_BIQUAD_NUM2        (0)
    #define ADC_CFG0_FILTER_UAB_BIQUAD_DEN0        (0)
    #define ADC_CFG0_FILTER_UAB_BIQUAD_DEN1        (0)
    #define ADC_CFG0_FILTER_UAB_BIQUAD_DEN2        (0)
    ...
    #define ADC_CFG0_UABH_B_STARTUP_DELAY    ((uint32)((uint32)0u << CyUAB_STARTUP_DELAY_SHIFT))
        ...
        #define ADC_CFG0_UABH_A_LOWQDYN_CAP_CTRL ((((ADC_CFG0_FILTER_GT_C1_NUMERATOR_VAL > 0u) \
            ...
            #define ADC_CFG0_UABH_A_LOWQDYN_SW_CB_IN0    ((ADC_UABH_ALL_OPEN_CB_IN0 \
                                                                &   ~((uint32)CyUAB_CLOCK_MASK << (ADC_UABH_A_halfuab__X0 << 2u))) \
                                                                |   ((uint32)CyUAB_CLK_PHI1 << (ADC_UABH_A_halfuab__X0 << 2u)))

            #define ADC_CFG0_UABH_A_LOWQDYN_SW_CB_IN1    ((CyUAB_CLK_PHI2 << CyUAB_SW_BG_MODBIT_SHIFT) \
                                                              |  (CyUAB_CLK_PHI4 << CyUAB_SW_BR_MODBIT_SHIFT) \
                                                              |  (CyUAB_CLK_PHI4 << CyUAB_SW_BV_MODBIT_SHIFT) \
                                                              |  (CyUAB_CLK_PHI4 << CyUAB_SW_BB_SHIFT))
            ...
            #define ADC_CFG0_UABH_A_LOWQDYN_SW_CB_IN0  ((ADC_UABH_ALL_OPEN_CB_IN0 \
                                                                &   ~((uint32)CyUAB_CLOCK_MASK << (ADC_UABH_A_halfuab__X0 << 2u))) \
                                                                |   (CyUAB_CLK_PHI5 << (ADC_UABH_A_halfuab__X0 << 2u)))

            #define ADC_CFG0_UABH_A_LOWQDYN_SW_CB_IN1  ((CyUAB_CLK_PHI4 << CyUAB_SW_BG_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_BR_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_BV_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_BB_SHIFT))

            #define ADC_CFG0_UABH_A_LOWQDYN_SW_CB_TOP  ((CyUAB_CLK_PHI5 << CyUAB_SW_SB_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_RB_MODBIT_SHIFT) \
        ...
        #define ADC_CFG0_UABH_B_LOWQDYN_CAP_CTRL     ((ADC_CFG0_FILTER_GT_Cpp_DENOMINATOR_VAL > 1u) \
                                                            ? (uint32)((uint32)1u << CyUAB_CC_GND_SHIFT) \
                                                            : 0u)
        #define ADC_CFG0_UABH_B_LOWQDYN_SW_CC_TOP    ((CyUAB_CLK_PHI5 << CyUAB_SW_SC_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_RC_MODBIT_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_GC_MODBIT_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_VC_MODBIT_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_ZC_SHIFT) \
    ...
    *******************************************************************************/
        ...
        #define ADC_CFG0_UABH_B_HIGHQDYN_SW_CB_TOP ((CyUAB_CLK_PHI5 << CyUAB_SW_SB_SHIFT) \
                                                        |  (CyUAB_CLK_PHI4 << CyUAB_SW_GB_MODBIT_SHIFT) \
                                                        |  (CyUAB_CLK_PHI4 << CyUAB_SW_RB_MODBIT_SHIFT) \
                                                        |  (CyUAB_CLK_PHI4 << CyUAB_SW_VB_MODBIT_SHIFT) \
...
*******************************************************************************/
    ...
    #define ADC_CFG1_TRANSFERTYPE      ADC_TRANSFERTYPE_
    /* Capacitors that can be fractional should have *
     * a numerator 0-63 and a denominator 1 or 64.   *
     * CA may have a value 1-127.                    *
     * CB may only have a value 2-64                 */
    ...
    #define ADC_CFG1_UABH_B_STARTUP_DELAY    ((uint32)((uint32)u << CyUAB_STARTUP_DELAY_SHIFT))
        ...
        #define ADC_CFG1_UABH_A_LOWQDYN_CAP_CTRL ((((ADC_CFG1_FILTER_GT_C1_NUMERATOR_VAL > 0u) \
            ...
            #define ADC_CFG1_UABH_A_LOWQDYN_SW_CB_IN0    ((ADC_UABH_ALL_OPEN_CB_IN0 \
                                                                &   ~((uint32)CyUAB_CLOCK_MASK << (ADC_UABH_A_halfuab__X0 << 2u))) \
                                                                |   ((uint32)CyUAB_CLK_PHI1 << (ADC_UABH_A_halfuab__X0 << 2u)))

            #define ADC_CFG1_UABH_A_LOWQDYN_SW_CB_IN1    ((CyUAB_CLK_PHI2 << CyUAB_SW_BG_MODBIT_SHIFT) \
                                                              |  (CyUAB_CLK_PHI4 << CyUAB_SW_BR_MODBIT_SHIFT) \
                                                              |  (CyUAB_CLK_PHI4 << CyUAB_SW_BV_MODBIT_SHIFT) \
                                                              |  (CyUAB_CLK_PHI4 << CyUAB_SW_BB_SHIFT))
            ...
            #define ADC_CFG1_UABH_A_LOWQDYN_SW_CB_IN1    ((CyUAB_CLK_PHI4 << CyUAB_SW_BG_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_BR_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_BV_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_BB_SHIFT))

            #define ADC_CFG1_UABH_A_LOWQDYN_SW_CB_TOP    ((CyUAB_CLK_PHI5 << CyUAB_SW_SB_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_RB_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_GB_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_VB_MODBIT_SHIFT) \
                                                                | (CyUAB_CLK_PHI5 << CyUAB_SW_TB_SHIFT))
        ...
        #define ADC_CFG1_UABH_B_LOWQDYN_CAP_CTRL     ((ADC_CFG1_FILTER_GT_Cpp_DENOMINATOR_VAL > 1u) \
                                                            ? (uint32)((uint32)1u << CyUAB_CC_GND_SHIFT) \
                                                            : 0u)
        #define ADC_CFG1_UABH_B_LOWQDYN_SW_CC_TOP    ((CyUAB_CLK_PHI5 << CyUAB_SW_SC_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_RC_MODBIT_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_GC_MODBIT_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_VC_MODBIT_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_ZC_SHIFT) \
    ...
    *******************************************************************************/
        ...
        #define ADC_CFG1_UABH_B_HIGHQDYN_SW_CB_TOP ((CyUAB_CLK_PHI5 << CyUAB_SW_SB_SHIFT) \
                                                        |  (CyUAB_CLK_PHI4 << CyUAB_SW_GB_MODBIT_SHIFT) \
                                                        |  (CyUAB_CLK_PHI4 << CyUAB_SW_RB_MODBIT_SHIFT) \
                                                        |  (CyUAB_CLK_PHI4 << CyUAB_SW_VB_MODBIT_SHIFT) \
...
*******************************************************************************/
    ...
    #define ADC_CFG2_TRANSFERTYPE      ADC_TRANSFERTYPE_
    /* Capacitors that can be fractional should have *
     * a numerator 0-63 and a denominator 1 or 64.   *
     * CA may have a value 1-127.                    *
     * CB may only have a value 2-64                 */
    ...
    #define ADC_CFG2_UABH_B_STARTUP_DELAY    ((uint32)((uint32)u << CyUAB_STARTUP_DELAY_SHIFT))
        ...
        #define ADC_CFG2_UABH_A_LOWQDYN_CAP_CTRL ((((ADC_CFG2_FILTER_GT_C1_NUMERATOR_VAL > 0u) \
            ...
            #define ADC_CFG2_UABH_A_LOWQDYN_SW_CB_IN0    ((ADC_UABH_ALL_OPEN_CB_IN0 \
                                                                &   ~((uint32)CyUAB_CLOCK_MASK << (ADC_UABH_A_halfuab__X0 << 2u))) \
                                                                |   ((uint32)CyUAB_CLK_PHI1 << (ADC_UABH_A_halfuab__X0 << 2u)))

            #define ADC_CFG2_UABH_A_LOWQDYN_SW_CB_IN1    ((CyUAB_CLK_PHI2 << CyUAB_SW_BG_MODBIT_SHIFT) \
                                                              |  (CyUAB_CLK_PHI4 << CyUAB_SW_BR_MODBIT_SHIFT) \
                                                              |  (CyUAB_CLK_PHI4 << CyUAB_SW_BV_MODBIT_SHIFT) \
                                                              |  (CyUAB_CLK_PHI4 << CyUAB_SW_BB_SHIFT))
            ...
            #define ADC_CFG2_UABH_A_LOWQDYN_SW_CB_IN1    ((CyUAB_CLK_PHI4 << CyUAB_SW_BG_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_BR_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_BV_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_BB_SHIFT))

            #define ADC_CFG2_UABH_A_LOWQDYN_SW_CB_TOP    ((CyUAB_CLK_PHI5 << CyUAB_SW_SB_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_RB_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_GB_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_VB_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI5 << CyUAB_SW_TB_SHIFT))
        ...
        #define ADC_CFG2_UABH_B_LOWQDYN_SW_CC_TOP    ((CyUAB_CLK_PHI5 << CyUAB_SW_SC_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_RC_MODBIT_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_GC_MODBIT_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_VC_MODBIT_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_ZC_SHIFT) \
    ...
    *******************************************************************************/
        ...
        #define ADC_CFG2_UABH_B_HIGHQDYN_SW_CB_TOP ((CyUAB_CLK_PHI5 << CyUAB_SW_SB_SHIFT) \
                                                        |  (CyUAB_CLK_PHI4 << CyUAB_SW_GB_MODBIT_SHIFT) \
                                                        |  (CyUAB_CLK_PHI4 << CyUAB_SW_RB_MODBIT_SHIFT) \
                                                        |  (CyUAB_CLK_PHI4 << CyUAB_SW_VB_MODBIT_SHIFT) \
...
*******************************************************************************/
    ...
    #define ADC_CFG3_TRANSFERTYPE      ADC_TRANSFERTYPE_
    /* Capacitors that can be fractional should have *
     * a numerator 0-63 and a denominator 1 or 64.   *
     * CA may have a value 1-127.                    *
     * CB may only have a value 2-64                 */
    ...
    #define ADC_CFG3_UABH_B_STARTUP_DELAY    ((uint32)((uint32)u << CyUAB_STARTUP_DELAY_SHIFT))
        ...
        #define ADC_CFG3_UABH_A_LOWQDYN_CAP_CTRL ((((ADC_CFG3_FILTER_GT_C1_NUMERATOR_VAL > 0u) \
            ...
            #define ADC_CFG3_UABH_A_LOWQDYN_SW_CB_IN0    ((ADC_UABH_ALL_OPEN_CB_IN0 \
                                                                &   ~((uint32)CyUAB_CLOCK_MASK << (ADC_UABH_A_halfuab__X0 << 2u))) \
                                                                |   ((uint32)CyUAB_CLK_PHI1 << (ADC_UABH_A_halfuab__X0 << 2u)))

            #define ADC_CFG3_UABH_A_LOWQDYN_SW_CB_IN1    ((CyUAB_CLK_PHI2 << CyUAB_SW_BG_MODBIT_SHIFT) \
                                                              |  (CyUAB_CLK_PHI4 << CyUAB_SW_BR_MODBIT_SHIFT) \
                                                              |  (CyUAB_CLK_PHI4 << CyUAB_SW_BV_MODBIT_SHIFT) \
                                                              |  (CyUAB_CLK_PHI4 << CyUAB_SW_BB_SHIFT))
            ...
            #define ADC_CFG3_UABH_A_LOWQDYN_SW_CB_IN1    ((CyUAB_CLK_PHI4 << CyUAB_SW_BG_MODBIT_SHIFT) \
                                                                |       (CyUAB_CLK_PHI4 << CyUAB_SW_BR_MODBIT_SHIFT) \
                                                                |       (CyUAB_CLK_PHI4 << CyUAB_SW_BV_MODBIT_SHIFT) \
                                                                |       (CyUAB_CLK_PHI4 << CyUAB_SW_BB_SHIFT))

            #define ADC_CFG3_UABH_A_LOWQDYN_SW_CB_TOP    ((CyUAB_CLK_PHI5 << CyUAB_SW_SB_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_RB_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_GB_MODBIT_SHIFT) \
                                                                |   (CyUAB_CLK_PHI4 << CyUAB_SW_VB_MODBIT_SHIFT) \
                                                                | (CyUAB_CLK_PHI5 << CyUAB_SW_TB_SHIFT))
        ...
        #define ADC_CFG3_UABH_B_LOWQDYN_CAP_CTRL     ((ADC_CFG3_FILTER_GT_Cpp_DENOMINATOR_VAL > 1u) \
                                                            ? (uint32)((uint32)1u << CyUAB_CC_GND_SHIFT) \
                                                            : 0u)
        #define ADC_CFG3_UABH_B_LOWQDYN_SW_CC_TOP    ((CyUAB_CLK_PHI5 << CyUAB_SW_SC_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_RC_MODBIT_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_GC_MODBIT_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_VC_MODBIT_SHIFT) \
                                                            | (CyUAB_CLK_PHI4 << CyUAB_SW_ZC_SHIFT) \
    ...
    *******************************************************************************/
        ...
        #define ADC_CFG3_UABH_B_HIGHQDYN_SW_CB_TOP ((CyUAB_CLK_PHI5 << CyUAB_SW_SB_SHIFT) \
                                                        |  (CyUAB_CLK_PHI4 << CyUAB_SW_GB_MODBIT_SHIFT) \
                                                        |  (CyUAB_CLK_PHI4 << CyUAB_SW_RB_MODBIT_SHIFT) \
                                                        |  (CyUAB_CLK_PHI4 << CyUAB_SW_VB_MODBIT_SHIFT) \
