...
#define ADC_ClearInterrupt() do{ADC_SAR_INTR_REG = ADC_EOS_MASK;}while(0)
...
#define ADC_CFG0_APERTURE_TIME0          (106uL)
...
#define ADC_CFG0_AVGERAGING_MODE         (2uL)
...
/* Filter Parameters */
    ...
    #define ADC_CFG0_FILTERTRIMDELAY     (143u)
...
/* ************************************************************************** */
    ...
    /* Timing settings */
        ...
        #define ADC_CFG1_FILTERTRIMDELAY     (u)
...
/* ************************************************************************** */
    ...
    /* Timing settings */
        ...
        #define ADC_CFG2_FILTERTRIMDELAY     (u)
...
/* ************************************************************************** */
    ...
    /* Timing settings */
        ...
        #define ADC_CFG3_FILTERTRIMDELAY     (u)
...
#define ADC_SAR_CHAN_RESULT_REG            (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT00 )
#define ADC_SAR_CHAN_RESULT_PTR            ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT00 )

#define ADC_SAR_CHAN_RESULT_IND            ( ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT00 )

#define ADC_SAR_CHAN0_RESULT_REG           (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT00 )
#define ADC_SAR_CHAN0_RESULT_PTR           ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT00 )

#define ADC_SAR_CHAN1_RESULT_REG           (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT01 )
#define ADC_SAR_CHAN1_RESULT_PTR           ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT01 )

#define ADC_SAR_CHAN2_RESULT_REG           (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT02 )
#define ADC_SAR_CHAN2_RESULT_PTR           ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT02 )

#define ADC_SAR_CHAN3_RESULT_REG           (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT03 )
#define ADC_SAR_CHAN3_RESULT_PTR           ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT03 )

#define ADC_SAR_CHAN4_RESULT_REG           (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT04 )
#define ADC_SAR_CHAN4_RESULT_PTR           ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT04 )

#define ADC_SAR_CHAN5_RESULT_REG           (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT05 )
#define ADC_SAR_CHAN5_RESULT_PTR           ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT05 )

#define ADC_SAR_CHAN6_RESULT_REG           (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT06 )
#define ADC_SAR_CHAN6_RESULT_PTR           ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT06 )

#define ADC_SAR_CHAN7_RESULT_REG           (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT07 )
#define ADC_SAR_CHAN7_RESULT_PTR           ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT07 )

#define ADC_SAR_CHAN8_RESULT_REG           (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT08 )
#define ADC_SAR_CHAN8_RESULT_PTR           ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT08 )

#define ADC_SAR_CHAN9_RESULT_REG           (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT09 )
#define ADC_SAR_CHAN9_RESULT_PTR           ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT09 )

#define ADC_SAR_CHAN10_RESULT_REG          (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT10 )
#define ADC_SAR_CHAN10_RESULT_PTR          ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT10 )

#define ADC_SAR_CHAN11_RESULT_REG          (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT11 )
#define ADC_SAR_CHAN11_RESULT_PTR          ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT11 )

#define ADC_SAR_CHAN12_RESULT_REG          (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT12 )
#define ADC_SAR_CHAN12_RESULT_PTR          ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT12 )

#define ADC_SAR_CHAN13_RESULT_REG          (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT13 )
#define ADC_SAR_CHAN13_RESULT_PTR          ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT13 )

#define ADC_SAR_CHAN14_RESULT_REG          (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT14 )
#define ADC_SAR_CHAN14_RESULT_PTR          ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT14 )

#define ADC_SAR_CHAN15_RESULT_REG          (*(reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT15 )
#define ADC_SAR_CHAN15_RESULT_PTR          ( (reg32 *) ADC_cy_psoc4_sar_1__SAR_CHAN_RESULT15 )
...
#define ADC_SAR_INJ_CHAN_CONFIG_REG        (*(reg32 *) ADC_cy_psoc4_sarmux_1__SAR_INJ_CHAN_CONFIG)
#define ADC_SAR_INJ_CHAN_CONFIG_PTR        ( (reg32 *) ADC_cy_psoc4_sarmux_1__SAR_INJ_CHAN_CONFIG)

#define ADC_SAR_INJ_RESULT_REG             (*(reg32 *) ADC_cy_psoc4_sarmux_1__SAR_INJ_RESULT )
#define ADC_SAR_INJ_RESULT_PTR             ( (reg32 *) ADC_cy_psoc4_sarmux_1__SAR_INJ_RESULT )
/* CDT-230388: These constants are getting added to cyfitter.h */
...
#if (0)
#define ADC_CFG0_TARGET_SPS 100000
#define ADC_CFG0_ACHIEVED_SPS 100000
#define ADC_CFG0_ADC_CLOCK_FREQ_HZ 12000000
#define ADC_CFG0_VREF_SOURCE VREFSOURCE_VBGR
#define ADC_CFG0_VREF_BYPASS True
#define ADC_CFG0_VNEG_SOURCE VNEGSOURCE_VREFSHORT
#define ADC_CFG0_NUM_SAMPLES_AVERAGED TWO_SAMPLES
#define ADC_CFG0_AVERAGING_MODE INTERLEAVED_AVG
#define ADC_CFG0_ALT_RES EIGHT_BIT
#define ADC_CFG0_FILTER_TYPE LOW_PASS
#define ADC_CFG0_FILTER_F1_KHZ 10
#define ADC_CFG0_FILTER_F2_KHZ -1
...
#define ADC_CFG0_CHAN0_INPUT_MODE SINGLE_ENDED_CHAN
#define ADC_CFG0_CHAN0_USE_AVERAGING False
#define ADC_CFG0_CHAN0_MIN_ACQ_TIME_NS 194
#define ADC_CFG0_CHAN0_ACHIEVED_ACQ_TIME_NS 8792
