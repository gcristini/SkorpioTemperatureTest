...
#define UART_PC_SPI_INTR_RX_MASK           (0x0u)
#define UART_PC_SPI_INTR_TX_MASK           (0x0u)
...
#define UART_PC_UART_MP_RX_ADDRESS         (0x2u)
#define UART_PC_UART_MP_RX_ADDRESS_MASK    (0xFFu)

#define UART_PC_UART_INTERRUPT_MODE        (1u)

#define UART_PC_UART_INTR_RX_MASK          (0x4u)
#define UART_PC_UART_INTR_TX_MASK          (0x0u)
...
#define UART_PC_UART_RX_BREAK_WIDTH        (11u)
...
***************************************/
    ...
    #define UART_PC_UART_DEFAULT_UART_RX_CTRL \
                    (UART_PC_GET_UART_RX_CTRL_MODE(UART_PC_UART_STOP_BITS_NUM)                    | \
                     ...
                     UART_PC_GET_UART_RX_CTRL_BREAK_WIDTH(UART_PC_UART_RX_BREAK_WIDTH)            | \
