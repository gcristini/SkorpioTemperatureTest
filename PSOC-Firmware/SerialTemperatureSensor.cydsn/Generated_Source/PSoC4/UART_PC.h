...
#define UART_PC_COMP_VERSION_MAJOR    (4)
#define UART_PC_COMP_VERSION_MINOR    (0)
...
*/
#define UART_PC_SCB_SW_RESET   UART_PC_I2CFwBlockReset()
...
#define UART_PC_DISABLE_AUTO_DATA \
                do{                        \
                    UART_PC_I2C_CTRL_REG &= ((uint32) ~(UART_PC_I2C_CTRL_M_READY_DATA_ACK      |  \
                                                                 UART_PC_I2C_CTRL_M_NOT_READY_DATA_NACK |  \
                                                                 UART_PC_I2C_CTRL_S_READY_DATA_ACK      |  \
                                                                 UART_PC_I2C_CTRL_S_NOT_READY_DATA_NACK)); \
                }while(0)
...
#define UART_PC_GET_UART_RX_CTRL_BREAK_WIDTH(width)    (((uint32) ((uint32) (width) - 1u) << \
                                                                    UART_PC_UART_RX_CTRL_BREAK_WIDTH_POS) & \
                                                                    UART_PC_UART_RX_CTRL_BREAK_WIDTH_MASK)
...
#define UART_PC_GET_TX_CTRL_DATA_WIDTH(dataWidth)  (((uint32) (dataWidth) - 1u) & \
                                                                UART_PC_TX_CTRL_DATA_WIDTH_MASK)
