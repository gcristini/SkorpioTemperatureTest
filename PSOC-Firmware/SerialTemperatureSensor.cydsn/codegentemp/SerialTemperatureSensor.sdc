...
# Date: Thu, 02 Jul 2020 14:52:41 GMT
#set_units -time ns
create_clock -name {ADC_Temp_intSarClock(FFB)} -period 83.333333333333329 -waveform {0 41.6666666666667} [list [get_pins {ClockBlock/ff_div_12}]]
...
create_generated_clock -name {ADC_Temp_intSarClock} -source [get_pins {ClockBlock/hfclk}] -edges {1 3 5} [list]
...
# Project: C:\Users\gcristini\OneDrive - Datalogic S.p.a\Data\PhytonWorkspace\SkorpioTemperatureTest\PSOC-Firmware\SerialTemperatureSensor.cydsn\SerialTemperatureSensor.cyprj
# Date: Thu, 02 Jul 2020 14:52:40 GMT
