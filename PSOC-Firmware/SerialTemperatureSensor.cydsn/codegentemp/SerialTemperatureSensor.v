...
module top ;
	...
	wire [0:0] tmpOE__Pin_DS18B20_DQ_net;
	wire [0:0] tmpFB_0__Pin_DS18B20_DQ_net;
	wire [0:0] tmpINTERRUPT_0__Pin_DS18B20_DQ_net;
	electrical [0:0] tmpSIOVREF__Pin_DS18B20_DQ_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("264be2d3-9481-494b-8d9c-c1905a45e9cc"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_DS18B20_DQ
		 (.oe(tmpOE__Pin_DS18B20_DQ_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_DS18B20_DQ_net[0:0]}),
		  .io({Net_241}),
		  .siovref(tmpSIOVREF__Pin_DS18B20_DQ_net),
		  .interrupt({tmpINTERRUPT_0__Pin_DS18B20_DQ_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_DS18B20_DQ_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
